...
public class GetAllIShenpiNew extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<AllShenPiBean> bean=service.GetAllShenPiNew(Integer.parseInt(userId), searchinfo,Integer.parseInt(size),Integer.parseInt(page));
		Gson gson=new Gson();
